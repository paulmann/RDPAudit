...
// Depends: System.Buffers.Binary, Crc32C
...
public readonly struct HeaderCopy : IEquatable<HeaderCopy>
{
	...
	public bool Equals(HeaderCopy other) => BlittableEquality.Equals(in this, in other);

	/// <inheritdoc />
	public override bool Equals(object? obj) => obj is HeaderCopy other && Equals(other);
	...
	/// <returns><c>true</c> when both serialise to identical bytes.</returns>
	public static bool operator ==(HeaderCopy left, HeaderCopy right) => left.Equals(right);
...
public readonly struct HeaderPayload : IEquatable<HeaderPayload>
{
	...
	/// <param name="other">Value to compare against.</param>
	/// <returns><c>true</c> when both serialise to identical bytes.</returns>
	public bool Equals(HeaderPayload other) => BlittableEquality.Equals(in this, in other);

	/// <inheritdoc />
	public override bool Equals(object? obj) => obj is HeaderPayload other && Equals(other);
	...
	/// <param name="right">Right operand.</param>
	/// <returns><c>true</c> when both serialise to identical bytes.</returns>
	public static bool operator ==(HeaderPayload left, HeaderPayload right) => left.Equals(right);
